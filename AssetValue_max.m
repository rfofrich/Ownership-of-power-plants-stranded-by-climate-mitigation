...
%Code is working fine, need to update section 4 fuel comibined to produced
%figure 1 for that paper. After this is complete the figures need to be
%edited and code redone to produce max and min values, and then produce
%figure for rcp 2.6
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for ii  = 1:2% sets fuel %1 COAL,2 GAS, 3 OIL, 4 Combined
clearvars -except ii; close all

section = 9;%section 7 must be set to ii = 4
%1 = aggregation of 'Plants' matrix containing plant info
...
elseif section == 2
 for gentype = FUEL
     CarbonTax19 = xlsread('../Data/CarbonTax1_9.xlsx','max');
     CarbonTax26 = xlsread('../Data/CarbonTax2_6.xlsx','max');
     if gentype == 1
        ...
        ax = gca;
        % exportgraphics(ax,['../Plots/Figure - price decline/coalmin_max.eps'],'ContentType','vector');    
     ...
     elseif gentype == 2
        ...
        caxis([nanmin(CarbonPrice) nanmax(CarbonPrice)])
        ax = gca;
        exportgraphics(ax,['../Plots/Figure - price decline/Gasmin_max.eps'],'ContentType','vector');    
     ...
     elseif gentype == 3
        ...
        LifeLeft = mean_Life - Plants(:,2);
            ...
            caxis([nanmin(CarbonPrice) nanmax(CarbonPrice)])
            ax = gca;
            exportgraphics(ax,['../Plots/Figure - price decline/Oilmin_max.eps'],'ContentType','vector');    
...
elseif section == 3%company financial calculations
    for gentype = FUEL
       ...
       Capacity = Plants(:,1);
        ...
        if saveresults == 1
            save(['../Data/Results/PowerPlantFinances_byCompany_' PowerPlantFuel{gentype} '_max.mat'],'PowerPlantFinances_byCompany','PowerPlantString_ByCompany','PowerPlantLife_byCompany','TotalPowerPlantCapacitybyCompany','PlantAge','AnnualStrandedAssets','PresentAssetValuebyCompany','StrandedAssetValuebyCompany','PowerPlantStrandedAssets_byCompany');
            save(['../Data/Results/PowerPlantFinances_byCountry_' PowerPlantFuel{gentype} '_max.mat'],'PowerPlantFinances_byCountry','PowerPlantString_ByCountry','PowerPlantStrandedAssets_byCountry');
            save(['../Data/Results/' PowerPlantFuel{gentype} 'Revenue_max.mat'],'RevenuebyCountry','RevenuebyCompany')
        end
    end
...
elseif section == 4%Figure - Annual Stranded Assets
    for gentype = FUEL
        if CombineFuelTypeResults ~= 1
            load(['../Data/Results/' PowerPlantFuel{gentype} '_Plants']);
            load(['../Data/Results/' PowerPlantFuel{gentype} '_Plants_strings']);      
            load(['../Data/Results/PowerPlantFinances_byCompany_' PowerPlantFuel{gentype} '_max.mat']);
%                 AnnualStrandedAssets = squeeze(nansum(AnnualStrandedAssets,2));
            ...
            if gentype == 1
                ...
                save('../Data/Results/CoalAnnualEmissions_max.mat','CoalAnnualEmissions_Fuel','CoalAnnualEmissions_Country','CoalAnnualEmissions_Company','AnnualEmissionsByCompany_Coal_strings','AnnualEmissionsByCountry_Coal_strings','CommittedEmissions');
                save('../Data/Results/CoalCompanyCapacity_max.mat','AnnualCapacityByCompany','NumberofPlantsperCompanyperYear');
                save('../Data/Results/CoalStrandedAssets_max.mat','AnnualStrandedAssetByCompany19_globalpricing_Coal','AnnualStrandedAssetByCompany26_globalpricing_Coal',...
                ...
                save('../Data/Results/GasAnnualEmissions_max.mat','GasAnnualEmissions_Fuel','GasAnnualEmissions_Country','GasAnnualEmissions_Company','AnnualEmissionsByCompany_Gas_strings','AnnualEmissionsByCountry_Gas_strings','CommittedEmissions');
                save('../Data/Results/GasCompanyCapacity_max.mat','AnnualCapacityByCompany','NumberofPlantsperCompanyperYear');
                save('../Data/Results/GasStrandedAssets_max.mat','AnnualStrandedAssetByCompany19_globalpricing_Gas','AnnualStrandedAssetByCompany26_globalpricing_Gas',...
        ...
        elseif CombineFuelTypeResults == 1
            load('../Data/Results/CoalAnnualEmissions_max.mat');
            load ../Data/Results/PowerPlantFinances_byCompany_Coal_max.mat
            load ../Data/Results/PowerPlantFinances_byCountry_Coal_max.mat
            load ../Data/Results/CoalStrandedAssets_max.mat
            ...
            load('../Data/Results/GasAnnualEmissions_max.mat');
            load ../Data/Results/PowerPlantFinances_byCompany_Gas_max.mat
            load ../Data/Results/PowerPlantFinances_byCountry_Gas_max.mat
            load ../Data/Results/GasStrandedAssets_max.mat
            ...
            aY = gca;
            exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualEmissions_byFuelmin_max.eps','ContentType','vector');    
...
%             colorbar([nanmin(CountrySAUnique) nanmax(CountrySAUnique)]);
            ...
            ylabel('Annual Emissions (GtCO2)')
            aY = gca;
            exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualEmissions_byCountrymin_max.eps','ContentType','vector');              
            ...
            ylabel('Annual Emissions (GtCO2)')
            aY = gca;
            exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualEmissions_byCompanymin_max.eps','ContentType','vector');   
            ...
            aY = gca;
            exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualStrandings_byFuel_barmin_max.eps','ContentType','vector');  
            ...
            % ylabel('Stranded Assets (USD $)')
            % aY = gca;
            % exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualStrandings_byFuel_Global19_maxmin_max.eps','ContentType','vector');    
            % 
            % figure()
            ...
            % ylabel('Stranded Assets (USD $)')
            % aY = gca;
            % exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualStrandings_byFuel_Global26min_max.eps','ContentType','vector');    
            % 
            ...
            % ylabel('Stranded Assets (USD $)')
            % aY = gca;
            % exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualStrandings_byFuel_Regional19_maxmin_max.eps','ContentType','vector');    
            % 
            % % 
            % figure()
            ...
            % ylabel('Stranded Assets (USD $)')
            % aY = gca;
            % exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualStrandings_byFuel_Regional26min_max.eps','ContentType','vector');    
            ...
            ylabel('Stranded Assets (USD $)')
            aY = gca;
            exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualStrandings_byCountry_1_9_barmin_max.eps','ContentType','vector');
            ...
            ylabel('Stranded Assets (USD $)')
            aY = gca;
            % exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualAssets_byCountry_global19min_max.eps','ContentType','vector');  
            ...
            ylabel('Stranded Assets (USD $)')
            aY = gca;
            exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualStrandings_byCountry_2_6_barmin_max.eps','ContentType','vector');
            ...
            % ylabel('Stranded Assets (USD $)')
            % aY = gca;
            % exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualAssets_byCountry_global26min_max.eps','ContentType','vector');  
            ...
            % ylim([0 14e12])
            aY = gca;
            % exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualAssets_byCountry_regional19min_max.eps','ContentType','vector');  
            ...
            ylabel('Stranded Assets (USD $)')
            aY = gca;
            % exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualAssets_byCountry_regional26min_max.eps','ContentType','vector');  
            % 
            ...
            ylabel('Stranded Assets (USD $)')
            aY = gca;
            exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualStrandings_byCompany_1_9_barmin_max.eps','ContentType','vector');
            ...
            ylabel('Stranded Assets ($-USD)')
            aY = gca;
            % exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualAssets_byCompany_global19min_max.eps','ContentType','vector');  
            ...
            ylabel('Stranded Assets (USD $)')
            aY = gca;
            exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualStrandings_byCompany_2_6_barmin_max.eps','ContentType','vector');
            ...
            ylabel('Stranded Assets ($-USD)')
            aY = gca;
            % exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualAssets_byCompany_global26min_max.eps','ContentType','vector');  
            ...
            ylabel('Stranded Assets ($-USD)')
            aY = gca;
            % exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualAssets_byCompany_regional19min_max.eps','ContentType','vector');  
            ...
            ylabel('Stranded Assets ($-USD)')
            aY = gca;
            % exportgraphics(aY,'../Plots/Figure - Annual Stranded Assets/AnnualAssets_byCompany_regional26min_max.eps','ContentType','vector');  
            % 
...
%                 aY = gca;
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_TopTenCompanies_StrandedAssets_coal_global19min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_TopTenCompanies_StrandedAssets_coal_global19min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_TopTenCompanies_StrandedAssets_coal_global19min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_TopTenCompanies_StrandedAssets_coal_global19min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_TopTenCompanies_StrandedAssets_coal_global19min_max.eps','ContentType','vector');
%                 end
% 
% 
...
%                 aY = gca;
% %                 exportgraphics(aY,'../Plots/Figure - pie graphs/NextNinetyCompanies_StrandedAssets_coal_global19min_max.eps','ContentType','vector');
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_NextNinetyCompanies_StrandedAssets_coal_global19min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_NextNinetyCompanies_StrandedAssets_coal_global19min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_NextNinetyCompanies_StrandedAssets_coal_global19min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_NextNinetyCompanies_StrandedAssets_coal_global19min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_NextNinetyCompanies_StrandedAssets_coal_global19min_max.eps','ContentType','vector');
%                 end
% 
...
%                 cx = gca;
%                 xlim([0 1])
% %                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_top10_coal_global19min_max.eps'],'ContentType','vector');
...
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_PercentAssetValue_top10_coal_global19min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_PercentAssetValue_top10_coal_global19min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_PercentAssetValue_top10_coal_global19min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_PercentAssetValue_top10_coal_global19min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_PercentAssetValue_top10_coal_global19min_max.eps','ContentType','vector');
%                 end
% 
...
%                 cx = gca;
%                 xlim([0 1])
% %                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_next90_coal_global19min_max.eps'],'ContentType','vector');
...
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_PercentAssetValue_next90_coal_global19min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_PercentAssetValue_next90_coal_global19min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_PercentAssetValue_next90_coal_global19min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_PercentAssetValue_next90_coal_global19min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_PercentAssetValue_next90_coal_global19min_max.eps','ContentType','vector');
%                 end
% 
...
%                 aY = gca;
% %                 exportgraphics(aY,'../Plots/Figure - pie graphs/TopTenCompanies_StrandedAssets_coal_global26min_max.eps','ContentType','vector');
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_TopTenCompanies_StrandedAssets_coal_global26min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_TopTenCompanies_StrandedAssets_coal_global26min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_TopTenCompanies_StrandedAssets_coal_global26min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_TopTenCompanies_StrandedAssets_coal_global26min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_TopTenCompanies_StrandedAssets_coal_global26min_max.eps','ContentType','vector');
%                 end
% 
% 
%                 TopStrandingsMatrix = nan(length(TopTenPercentStranded),5);
...
%                 pie(Next90_StrandedAssets,Next90_CompanyNames)
%                 aY = gca;
% %                 exportgraphics(aY,'../Plots/Figure - pie graphs/NextNianetyCompanies_StrandedAssets_coal_global26min_max.eps','ContentType','vector');
% 
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_NextNinetyCompanies_StrandedAssets_coal_global26min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_NextNinetyCompanies_StrandedAssets_coal_global26min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_NextNinetyCompanies_StrandedAssets_coal_global26min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_NextNinetyCompanies_StrandedAssets_coal_global26min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_NextNinetyCompanies_StrandedAssets_coal_global26min_max.eps','ContentType','vector');
%                 end
% 
%                 edges = zeros(length(TopTenPercentStranded)+1,1);
%                 edges(2:end,1) = 1:1:length(edges)-1;
...
%                 cx = gca;
%                 xlim([0 1])
% %                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_top10_coal_global26min_max.eps'],'ContentType','vector');
...
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_PercentAssetValue_top10_coal_global26min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_PercentAssetValue_top10_coal_global26min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_PercentAssetValue_top10_coal_global26min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_PercentAssetValue_top10_coal_global26min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_PercentAssetValue_top10_coal_global26min_max.eps','ContentType','vector');
%                 end
% 
% 
%                 edges = zeros(length(NextNinetyPercentStranded)+1,1);
...
%                 cx = gca;
%                 xlim([0 1])
% %                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_next90_coal_global26min_max.eps'],'ContentType','vector');
...
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_PercentAssetValue_next90_coal_global26min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_PercentAssetValue_next90_coal_global26min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_PercentAssetValue_next90_coal_global26min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_PercentAssetValue_next90_coal_global26min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_PercentAssetValue_top10_coal_global26min_max.eps','ContentType','vector');
%                 end
% 
...
%                 aY = gca;
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_TopTenCompanies_StrandedAssets_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_TopTenCompanies_StrandedAssets_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_TopTenCompanies_StrandedAssets_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_TopTenCompanies_StrandedAssets_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_TopTenCompanies_StrandedAssets_Gas_global19min_max.eps','ContentType','vector');
%                 end
% 
% 
%                 TopTenPercentStranded = TopTen_StrandedAssets19./PresentAssetValue(indx,:);
...
%                 pie(Next90_StrandedAssets,Next90_CompanyNames)
%                 aY = gca;
% %                 exportgraphics(aY,'../Plots/Figure - pie graphs/NextNinetyCompanies_StrandedAssets_Gas_global19min_max.eps','ContentType','vector');
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_NextNinetyCompanies_StrandedAssets_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_NextNinetyCompanies_StrandedAssets_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_NextNinetyCompanies_StrandedAssets_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_NextNinetyCompanies_StrandedAssets_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_NextNinetyCompanies_StrandedAssets_Gas_global19min_max.eps','ContentType','vector');
%                 end
% 
%                 edges = zeros(length(TopTenPercentStranded)+1,1);
%                 edges(2:end,1) = 1:1:length(edges)-1;
...
%                 cx = gca;
%                 xlim([0 1])
% %                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_top10_Gas_global19min_max.eps'],'ContentType','vector');
...
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_PercentAssetValue_top10_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_PercentAssetValue_top10_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_PercentAssetValue_top10_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_PercentAssetValue_top10_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_PercentAssetValue_top10_Gas_global19min_max.eps','ContentType','vector');
%                 end
% 
%                 edges = zeros(length(NextNinetyPercentStranded)+1,1);
%                 edges(2:end,1) = 1:1:length(edges)-1;
...
%                 cx = gca;
%                 xlim([0 1])
% %                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_next90_Gas_global19min_max.eps'],'ContentType','vector');
...
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_PercentAssetValue_next90_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_PercentAssetValue_next90_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_PercentAssetValue_next90_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_PercentAssetValue_next90_Gas_global19min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_PercentAssetValue_next90_Gas_global19min_max.eps','ContentType','vector');
%                 end
% 
%                 GlobalStrandedAssetValue26 = StrandedAssetValuebyCompany(CountryINDEX,3); 
% 
...
%                 pie(TopTen_StrandedAssets26,TopTen_CompanyNames)
%                 aY = gca;
% %                 exportgraphics(aY,'../Plots/Figure - pie graphs/TopTenCompanies_StrandedAssets_Gas_global26min_max.eps','ContentType','vector');
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_TopTenCompanies_StrandedAssets_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_TopTenCompanies_StrandedAssets_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_TopTenCompanies_StrandedAssets_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_TopTenCompanies_StrandedAssets_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_TopTenCompanies_StrandedAssets_Gas_global26min_max.eps','ContentType','vector');
%                 end
% 
% 
%                 TopStrandingsMatrix = nan(length(TopTenPercentStranded),5);
...
%                 pie(Next90_StrandedAssets,Next90_CompanyNames)
%                 aY = gca;
% %                 exportgraphics(aY,'../Plots/Figure - pie graphs/NextNianetyCompanies_StrandedAssets_Gas_global26min_max.eps','ContentType','vector');
% 
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_NextNinetyCompanies_StrandedAssets_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_NextNinetyCompanies_StrandedAssets_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_NextNinetyCompanies_StrandedAssets_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_NextNinetyCompanies_StrandedAssets_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_NextNinetyCompanies_StrandedAssets_Gas_global26min_max.eps','ContentType','vector');
%                 end
% 
%                 edges = zeros(length(TopTenPercentStranded)+1,1);
%                 edges(2:end,1) = 1:1:length(edges)-1;
...
%                 cx = gca;
%                 xlim([0 1])
% %                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_top10_Gas_global26min_max.eps'],'ContentType','vector');
...
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_PercentAssetValue_top10_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_PercentAssetValue_top10_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_PercentAssetValue_top10_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_PercentAssetValue_top10_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_PercentAssetValue_top10_Gas_global26min_max.eps','ContentType','vector');
%                 end
% 
% 
%                 edges = zeros(length(NextNinetyPercentStranded)+1,1);
...
%                 cx = gca;
%                 xlim([0 1])
% %                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_next90_Gas_global26min_max.eps'],'ContentType','vector');
...
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_PercentAssetValue_next90_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_PercentAssetValue_next90_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_PercentAssetValue_next90_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_PercentAssetValue_next90_Gas_global26min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_PercentAssetValue_top10_Gas_global26min_max.eps','ContentType','vector');
%                 end
% 
...
%                 aY = gca;
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_TopTenCompanies_StrandedAssets_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_TopTenCompanies_StrandedAssets_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_TopTenCompanies_StrandedAssets_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_TopTenCompanies_StrandedAssets_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_TopTenCompanies_StrandedAssets_Oil_global19min_max.eps','ContentType','vector');
%                 end
% 
% 
%                 TopTenPercentStranded = TopTen_StrandedAssets19./PresentAssetValue(indx,:);
...
%                 pie(Next90_StrandedAssets,Next90_CompanyNames)
%                 aY = gca;
% %                 exportgraphics(aY,'../Plots/Figure - pie graphs/NextNinetyCompanies_StrandedAssets_Oil_global19min_max.eps','ContentType','vector');
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_NextNinetyCompanies_StrandedAssets_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_NextNinetyCompanies_StrandedAssets_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_NextNinetyCompanies_StrandedAssets_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_NextNinetyCompanies_StrandedAssets_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_NextNinetyCompanies_StrandedAssets_Oil_global19min_max.eps','ContentType','vector');
%                 end
% 
%                 edges = zeros(length(TopTenPercentStranded)+1,1);
%                 edges(2:end,1) = 1:1:length(edges)-1;
...
%                 cx = gca;
%                 xlim([0 1])
% %                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_top10_Oil_global19min_max.eps'],'ContentType','vector');
...
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_PercentAssetValue_top10_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_PercentAssetValue_top10_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_PercentAssetValue_top10_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_PercentAssetValue_top10_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_PercentAssetValue_top10_Oil_global19min_max.eps','ContentType','vector');
%                 end
% 
%                 edges = zeros(length(NextNinetyPercentStranded)+1,1);
%                 edges(2:end,1) = 1:1:length(edges)-1;
...
%                 cx = gca;
%                 xlim([0 1])
% %                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_next90_Oil_global19min_max.eps'],'ContentType','vector');
...
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_PercentAssetValue_next90_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_PercentAssetValue_next90_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_PercentAssetValue_next90_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_PercentAssetValue_next90_Oil_global19min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_PercentAssetValue_next90_Oil_global19min_max.eps','ContentType','vector');
%                 end
% 
%                 GlobalStrandedAssetValue26 = StrandedAssetValuebyCompany(CountryINDEX,3); 
% 
...
%                 pie(TopTen_StrandedAssets26,TopTen_CompanyNames)
%                 aY = gca;
% %                 exportgraphics(aY,'../Plots/Figure - pie graphs/TopTenCompanies_StrandedAssets_Oil_global26min_max.eps','ContentType','vector');
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_TopTenCompanies_StrandedAssets_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_TopTenCompanies_StrandedAssets_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_TopTenCompanies_StrandedAssets_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_TopTenCompanies_StrandedAssets_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_TopTenCompanies_StrandedAssets_Oil_global26min_max.eps','ContentType','vector');
%                 end
% 
% 
%                 TopStrandingsMatrix = nan(length(TopTenPercentStranded),5);
...
%                 pie(Next90_StrandedAssets,Next90_CompanyNames)
%                 aY = gca;
% %                 exportgraphics(aY,'../Plots/Figure - pie graphs/NextNianetyCompanies_StrandedAssets_Oil_global26min_max.eps','ContentType','vector');
% 
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_NextNinetyCompanies_StrandedAssets_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_NextNinetyCompanies_StrandedAssets_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_NextNinetyCompanies_StrandedAssets_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_NextNinetyCompanies_StrandedAssets_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_NextNinetyCompanies_StrandedAssets_Oil_global26min_max.eps','ContentType','vector');
%                 end
% 
%                 edges = zeros(length(TopTenPercentStranded)+1,1);
%                 edges(2:end,1) = 1:1:length(edges)-1;
...
%                 cx = gca;
%                 xlim([0 1])
% %                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_top10_Oil_global26min_max.eps'],'ContentType','vector');
...
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_PercentAssetValue_top10_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_PercentAssetValue_top10_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_PercentAssetValue_top10_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_PercentAssetValue_top10_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_PercentAssetValue_top10_Oil_global26min_max.eps','ContentType','vector');
%                 end
% 
% 
%                 edges = zeros(length(NextNinetyPercentStranded)+1,1);
...
%                 cx = gca;
%                 xlim([0 1])
% %                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_next90_Oil_global26min_max.eps'],'ContentType','vector');
...
% 
%                 if I == 1
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/US_PercentAssetValue_next90_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I ~= 1 &&I ~= 3 && I~= 4 && I~=9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/ROW_PercentAssetValue_next90_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I == 3
%                    exportgraphics(aY,'../Plots/Figure - pie graphs/China_PercentAssetValue_next90_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I == 4
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/Europe_PercentAssetValue_next90_Oil_global26min_max.eps','ContentType','vector');
%                 elseif I == 9
%                     exportgraphics(aY,'../Plots/Figure - pie graphs/India_PercentAssetValue_top10_Oil_global26min_max.eps','ContentType','vector');
%                 end
% 
...
%                 pie(TopTen_StrandedAssets19,TopTen_CompanyNames)
%                 aY = gca;
%                 exportgraphics(aY,'../Plots/Figure - pie graphs/TopTenCompanies_StrandedAssets_all_global19min_max.eps','ContentType','vector');
% 
%                 Next90_StrandedAssets = TopTen_StrandedAssets19;
%                 Next90_CompanyNames = TopTen_CompanyNames;
% 
...
%                 pie(Next90_StrandedAssets,Next90_CompanyNames)
%                 aY = gca;
%                 exportgraphics(aY,'../Plots/Figure - pie graphs/NextNinetyCompanies_StrandedAssets_all_global19min_max.eps','ContentType','vector');
% 
%                 edges = zeros(length(TopTenPercentStranded)+1,1);
%                 edges(2:end,1) = 1:1:length(edges)-1;
%                 vals = TopTenPercentStranded;
...
%                 cx = gca;
%                 xlim([0 1])
%                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_top10_all_global19min_max.eps'],'ContentType','vector');
% 
% 
%                 edges = zeros(length(NextNinetyPercentStranded)+1,1);
%                 edges(2:end,1) = 1:1:length(edges)-1;
...
%                 cx = gca;
%                 xlim([0 1])
%                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_next90_all_global19min_max.eps'],'ContentType','vector');
% 
% 
% 
...
%                 pie(TopTen_StrandedAssets26,TopTen_CompanyNames)
%                 aY = gca;
%                 exportgraphics(aY,'../Plots/Figure - pie graphs/TopTenCompanies_StrandedAssets_all_global26min_max.eps','ContentType','vector');
% 
%                 Next90_StrandedAssets = TopTen_StrandedAssets26;
%                 Next90_CompanyNames = TopTen_CompanyNames;
% 
...
%                 pie(Next90_StrandedAssets,Next90_CompanyNames)
%                 aY = gca;
%                 exportgraphics(aY,'../Plots/Figure - pie graphs/NextNinetyCompanies_StrandedAssets_all_global26min_max.eps','ContentType','vector');
% 
%                 edges = zeros(length(TopTenPercentStranded)+1,1);
%                 edges(2:end,1) = 1:1:length(edges)-1;
%                 vals = TopTenPercentStranded;
...
%                 cx = gca;
%                 xlim([0 1])
%                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_top10_all_global26min_max.eps'],'ContentType','vector');
% 
% 
%                 edges = zeros(length(NextNinetyPercentStranded)+1,1);
%                 edges(2:end,1) = 1:1:length(edges)-1;
...
%                 cx = gca;
%                 xlim([0 1])
%                 exportgraphics(cx,['../Plots/Figure - pie graphs/PercentAssetValue_next90_all_global26min_max.eps'],'ContentType','vector');
% 
% 
% 
% 
...
elseif section == 6%lorenz curve figure %%ignore section
    for gentype = FUEL
        if CombineFuelTypeResults ~= 1
            if gentype == 1                
                ...
                StrandedAssets = PowerPlantFinances_byCompany(:,:,5);
                StrandedAssets = nansum(StrandedAssets,2);
                
                [TopStrandedAsset_Companies indx] = maxk(StrandedAssets,20);
                TopStrandedAssetCompanyEmissions = CoalAnnualEmissions_Company(indx,:);
                TopStrandedAssetCompanyCapacity = AnnualCapacityByCompany(indx,:);
                TopStrandedAssetCompanyNames = PowerPlantString_ByCompany(indx,1);
                TopStrandedAssetCompanyAverageAge = PowerPlantLife_byCompany(indx,1);
            elseif gentype == 2
            ...
            elseif gentype == 3
                ...
                TopStrandedAssetCompanyEmissions(TopStrandedAssetCompanyEmissions==0) = nan;
                TopStrandedAssetCompanyEmissions = nanmean(TopStrandedAssetCompanyEmissions,2);
                
                TopStrandedAssetCompanyCapacity(TopStrandedAssetCompanyCapacity==0) = nan;
                TopStrandedAssetCompanyCapacity = nanmean(TopStrandedAssetCompanyCapacity,2);
                
                CDF_StrandedAssets = zeros(size(TopStrandedAssetCompanyCapacity));
                CDF_Capacity = zeros(size(TopStrandedAssetCompanyCapacity));
                
                PlantAgeRange = 1:40;
                
                barcolormap_fullrange = autumn(length(PlantAgeRange));
                barcolormap = zeros(length(TopStrandedAssetCompanyCapacity),3);
                
                for i = 1:length(TopStrandedAssetCompanyAverageAge)
                    for j = 1:length(PlantAgeRange)
                        if TopStrandedAssetCompanyAverageAge(i) == PlantAgeRange(j)
                            barcolormap(i,:) = barcolormap_fullrange(j,:);
                        elseif  TopStrandedAssetCompanyAverageAge(i) > nanmax(PlantAgeRange(j))
                            barcolormap(i,:) = barcolormap_fullrange(end,:);
                        end
                    end
                end
              
                TopCompanies = nan(length(TopStrandedAssetCompanyCapacity),3);
                TopCompanies(:,1) = 1:length(TopStrandedAssetCompanyCapacity);%replace with desired order
                TopCompanies(:,2) = TopStrandedAsset_Companies;
                TopCompanies(:,3) = TopStrandedAssetCompanyCapacity;%average capacity 
                TopCompanies(:,4) = TopStrandedAssetCompanyAverageAge;
                TopCompanies(:,5:7) = barcolormap;
%                 TopCompanies = sortrows(TopCompanies,4);%SortsbyAge
                
                TopCompanies = sortrows(TopCompanies,1);
                barcolormap = TopCompanies(:,5:7);
                
                
                TopStrandedAssetCompanyNames_Sorted =TopStrandedAssetCompanyNames(TopCompanies(:,1),1);
                TopCompanies = sortrows(TopCompanies,2);
                SortedAssetValue = TopCompanies(:,2);
                SortedAge = TopCompanies(:,4);
                CompanyCapacitySortedByAssetValue = TopCompanies(:,3);
                ShareofTotalCompanyEmissions = round(TopCompanies(:,3)./nansum(TopCompanies(:,3)),2);
                ShareofTotalCompanyEmissions(ShareofTotalCompanyEmissions==0) = min(setdiff(ShareofTotalCompanyEmissions,min(ShareofTotalCompanyEmissions)));
                
                
                 for i = 1:length(CDF_Capacity)
                    if i==1
                        CDF_Capacity(i,1) = CompanyCapacitySortedByAssetValue(i,1);
                    else
                        CDF_Capacity(i,1) = CompanyCapacitySortedByAssetValue(i,1) + CDF_Capacity(i-1,1);
                    end
                 end
                 
                 for i = 1:length(CDF_StrandedAssets)
                    if i==1
                        CDF_StrandedAssets(i,1) = SortedAssetValue(i,1);
                    else
                        CDF_StrandedAssets(i,1) = SortedAssetValue(i,1) + CDF_StrandedAssets(i-1,1);
                    end
                 end
                 
                             
                edges = zeros(length(CDF_Capacity)+1,1);
                edges(2:end,1) = CDF_Capacity;
                vals = CDF_StrandedAssets;
                center = (edges(1:end-1) + edges(2:end))/2;
                width = diff(edges);
                ...
                hold on
                for i=1:length(center)
                    bar(center(i),vals(i),width(i),'FaceColor', barcolormap(i,:))%
                end
                hold off
                xlabel('Share of total capacity (MW)')
                ylabel('Stranded asset ($)')
                ylim([0 nanmax(vals)])
                colormap(autumn)
                caxis([0 40])
                c = colorbar;
                c.Label.String = 'Average power generator age (years)';
                ax = gca;
                
                if FUEL == 1
                    exportgraphics(ax,['../Plots/Figure Lorenz/LorenzCurves_Coalmin_max.eps'],'ContentType','vector');    
                elseif FUEL == 2
                    exportgraphics(ax,['../Plots/Figure Lorenz/LorenzCurves_Gasmin_max.eps'],'ContentType','vector');
                end
...
%             AssetValuebyCountry = AssetValuebyCountry.*-1;
            ...
            if i == 1
                exportgraphics(ax,['../Plots/Figure X [Stranded asset maps]/Global carbon prices Stranded Assets rcp 19min_max.eps'],'ContentType','vector');    
            elseif i == 2
                exportgraphics(ax,['../Plots/Figure X [Stranded asset maps]/regional carbon prices Stranded Assets rcp 19min_max.eps'],'ContentType','vector');
            elseif i == 3
                exportgraphics(ax,['../Plots/Figure X [Stranded asset maps]/Global carbon prices Stranded Assets rcp 26min_max.eps'],'ContentType','vector'); 
            elseif i == 4
                exportgraphics(ax,['../Plots/Figure X [Stranded asset maps]/regional carbon prices Stranded Assets rcp 26min_max.eps'],'ContentType','vector');
            end
...
%             caxis([nanmin(nanmin(AssetValuebyCountry)) -1.5e10])
            ...
            ax = gca;
            if i == 1
                exportgraphics(ax,['../Plots/Figure X [Stranded asset maps]/Global carbon prices Stranded Assets per capita 19min_max.eps'],'ContentType','vector');    
            elseif i == 2
                exportgraphics(ax,['../Plots/Figure X [Stranded asset maps]/regional carbon prices Stranded Assets per capita 19min_max.eps'],'ContentType','vector');
            elseif i == 3
                exportgraphics(ax,['../Plots/Figure X [Stranded asset maps]/Global carbon prices Stranded Assets per capita 26min_max.eps'],'ContentType','vector');    
            elseif i == 4
                exportgraphics(ax,['../Plots/Figure X [Stranded asset maps]/regional carbon prices Stranded Assets per capita 26min_max.eps'],'ContentType','vector');
            end
...
elseif section == 8
        ...
        for i = 1:length(Companies) 
            ...
            legend('Coal','Gas','Oil')
            ax = gca;
            exportgraphics(ax,['../Plots/' Name 'Fuel composition piemin_max.eps'],'ContentType','vector');
        end

elseif section == 9
    load(['../Data/Results/DecommissionYear' PowerPlantFuel{FUEL} ''])
    if FUEL == 1
        load '../Data/Results/PowerPlantFinances_byCompany_Coal_max'
        load '../Data/Results/PowerPlantFinances_byCountry_Coal_max'
        load '../Data/Results/CoalAnnualEmissions_max.mat'
        load ../Data/Results/CoalCompanyCapacity.mat
        ...
        Unknown_companies_capacity = AnnualCapacityByCompany(Unknown_companies_index,:);
        ...
        AnnualCapacityByCompany(Unknown_companies_index,:) = 0;
        ...
        EmissionsbyCompany = EmissionsbyCompany/(1e9); %converts to Gt CO2
        ...
        revenue_marker_size = (RevenuebyCompany-min(RevenuebyCompany))/(max(RevenuebyCompany)-min(RevenuebyCompany));%normalized data between 0 and 1 for plotting
        revenue_scaled_sizes = min_marker_size + (max_marker_size - min_marker_size) * revenue_marker_size;


        figure()
        scatter(EmissionsbyCompany,StrandedAssetsbyCompany,revenue_scaled_sizes,Company_RGB_colors,'filled')
        set(gca,'xscale','log')
        set(gca,'yscale','log')
        xlabel('Emissions')
...
%         legend(RegionList)
        ax = gca;
        exportgraphics(ax,['../Plots/coal scatter emissionsmin_max.eps'],'ContentType','vector');
        ...
        % ylim([1e10,1.3e12])
        ax = gca;
        exportgraphics(ax,['../Plots/coal scatter installed capacitymin_max.eps'],'ContentType','vector');
        ...
        % ylim([1e10,1.3e12])
        ax = gca;
        exportgraphics(ax,['../Plots/coal scatter number of plantsmin_max.eps'],'ContentType','vector');
        ...
        figure()
        scatter(Lifeleft,StrandedAssetsbyCompany,revenue_scaled_sizes,Company_RGB_colors,'filled')
        set(gca,'yscale','log')
        set(gca,'zscale','log')
        ...
        % ylim([1e10,1.3e12])
        ax = gca;
        exportgraphics(ax,['../Plots/coal scatter years to retirementmin_max.eps'],'ContentType','vector');
        ...
        % ylim([1e10,1e12])
        ax = gca;
        exportgraphics(ax,'../Plots/coal scatter stranded assets remaining life standardized sizemin_max.eps','ContentType','vector');
...
%         legend(RegionList)
        ax = gca;
        exportgraphics(ax,'../Plots/coal scatter stranded assets EmissionsbyCompany standardized sizemin_max.eps','ContentType','vector');
        ...
        save('../Data/Results/EmissionsPerStrandedAssets_coal_max.mat','EmissionsPerStrandedAssets','EmissionsbyCompany','StrandedAssetsbyCompany','Company_RGB_colors')
        ...
        % ylim([0,60])
        ax = gca;
        exportgraphics(ax,'../Plots/Emissions per stranded assets coalmin_max.eps','ContentType','vector');
    ...
    elseif FUEL == 2
        ...
        load '../Data/Results/PowerPlantFinances_byCompany_Gas_max'
        load '../Data/Results/PowerPlantFinances_byCountry_Gas_max'
        load '../Data/Results/GasAnnualEmissions_max.mat'
...
%         legend(RegionList)
        ax = gca;
        % exportgraphics(ax,['../Plots/Gas scatter emissionsmin_max.eps'],'ContentType','vector');
        ...
        % ylim([min(StrandedAssetsbyCompany),1.75e11])
        ax = gca;
        % exportgraphics(ax,['../Plots/Gas scatter installed capacitymin_max.eps'],'ContentType','vector');
        ...
        % ylim([min(StrandedAssetsbyCompany),1.75e11])
        ax = gca;
        % exportgraphics(ax,['../Plots/Gas scatter number of plantsmin_max.eps'],'ContentType','vector');
        ...
        % ylim([min(StrandedAssetsbyCompany),1.75e11])
        ax = gca;
        % exportgraphics(ax,['../Plots/Gas scatter years to retirementmin_max.eps'],'ContentType','vector');
        ...
        ax = gca;
        exportgraphics(ax,'../Plots/gas scatter stranded assets remaining life standardized sizemin_max.eps','ContentType','vector');
        ...
        % ylim([min(StrandedAssetsbyCompany)-1e6,1.2e11])
%         legend(RegionList)
        ax = gca;
        exportgraphics(ax,'../Plots/gas scatter stranded assets EmissionsbyCompany standardized sizemin_max.eps','ContentType','vector');



        EmissionsPerStrandedAssets = ((CommittedEmissions)./(StrandedAssetsbyCompany*1e9)); %converts stranded assets back to $ instead of billions of dollar
        save('../Data/Results/EmissionsPerStrandedAssets_gas_max.mat','EmissionsPerStrandedAssets','StrandedAssetsbyCompany','EmissionsbyCompany','Company_RGB_colors')
        ...
        % ylim([0,100])
        ax = gca;
        exportgraphics(ax,'../Plots/Emissions per stranded assets gasmin_max.eps','ContentType','vector');
    ...
    elseif FUEL == 3
        ...
        revenue_marker_size = RevenuebyCompany*5000/(max(Revenue(:))/2);
        save('revenuebycompany_oil.mat','RevenuebyCompany')
        Standardized_scaled_size = (StrandedAssetsbyCompany./RevenuebyCompany)*100;

        figure()
        scatter(EmissionsbyCompany,StrandedAssetsbyCompany,revenue_marker_size,Company_RGB_colors,'filled')
        set(gca,'xscale','log')
        set(gca,'yscale','log')
        xlabel('Emissions')
        ylabel('Stranded assets')
...
%         legend(RegionList)
        ax = gca;
        % exportgraphics(ax,['../Plots/Oil scatter emissionsmin_max.eps'],'ContentType','vector');
        ...
        ylim([min(StrandedAssetsbyCompany),2.5e11])
        ax = gca;
        % exportgraphics(ax,['../Plots/Oil scatter installed capacitymin_max.eps'],'ContentType','vector');
        ...
        ylim([min(StrandedAssetsbyCompany),2.5e11])
        ax = gca;
%         exportgraphics(ax,['../Plots/Oil scatter number of plantsmin_max.eps'],'ContentType','vector');

        Lifeleft(Lifeleft<=0)=1;
        Lifeleft_size =Lifeleft*500/40;

        figure()
        scatter(Lifeleft,StrandedAssetsbyCompany,revenue_marker_size,[Company_RGB_colors],'filled')
        set(gca,'yscale','log')
        set(gca,'zscale','log')
        xlabel('Years to retirement')
        ylabel('Stranded assets')
        ylim([min(StrandedAssetsbyCompany),2.5e11])
        ax = gca;
        % exportgraphics(ax,['../Plots/Oil scatter years to retirementmin_max.eps'],'ContentType','vector');
        ...
        ax = gca;
        exportgraphics(ax,'../Plots/oil scatter stranded assets remaining life standardized sizemin_max.eps','ContentType','vector');
...
%         xlim([min(EmissionsbyCompany),1e10])
        ...
        legend show
        ax = gca;
        exportgraphics(ax,'../Plots/oil scatter stranded assets EmissionsbyCompany standardized sizemin_max.eps','ContentType','vector');
    

        EmissionsPerStrandedAssets = ((CommittedEmissions/1e9)./(StrandedAssetsbyCompany/1e9))*1000; 
        ...
        ylim([0,70])
        ax = gca;
        exportgraphics(ax,'../Plots/Emissions per stranded assets oilmin_max.eps','ContentType','vector');
...
elseif section == 10
    if FUEL == 1
        ...
        ylim([0 1e12])
        cx = gca;
        exportgraphics(cx,['../Plots/Coal_CDFmin_max.eps'],'ContentType','vector');   
...
% %         ylim([0 1e12])
%         cx = gca;
%         exportgraphics(cx,['../Plots/Coal_CDF_NPVmin_max.eps'],'ContentType','vector');
    ...
    elseif FUEL == 2
        ...
        ylim([0 1e14])
        cx = gca;
        exportgraphics(cx,['../Plots/Gas_CDFmin_max.eps'],'ContentType','vector');   
...
% %         ylim([0 1e12])
%         cx = gca;
%         exportgraphics(cx,['../Plots/Gas_CDF_NPVmin_max.eps'],'ContentType','vector');
    ...
    elseif FUEL == 3
        ...
        ylim([0 1e14])
        cx = gca;
        exportgraphics(cx,['../Plots/Oil_CDFmin_max.eps'],'ContentType','vector');   
...
% %         ylim([0 1e12])
%         cx = gca;
%         exportgraphics(cx,['../Plots/Oil_CDF_NPVmin_max.eps'],'ContentType','vector');
...
%             PowerPlantProfits_CarbonTax = zeros(length(Plants),length(sensitivity_range_CT),length(sensitivity_range_WS));
            ...
            ax = gca;
            exportgraphics(ax,['../Plots/coal_sensitivity_plotmin_max.eps'],'ContentType','vector');
...
%             PowerPlantProfits_CarbonTax = zeros(length(Plants),length(sensitivity_range_CT),length(sensitivity_range_WS));
            ...
            c.Label.String = 'Stranded Assets (Trillions of Dollars)'; % Label the colorbar
            ax = gca;
            exportgraphics(ax,['../Plots/gas_sensitivity_plotmin_max.eps'],'ContentType','vector');
...
%             PowerPlantProfits_CarbonTax = zeros(length(Plants),length(sensitivity_range_CT),length(sensitivity_range_WS));
            ...
            ax = gca;
            exportgraphics(ax,['../Plots/oil_sensitivity_plotmin_max.eps'],'ContentType','vector');
...
elseif section == 12
    ...
    EmissionsPerStrandedAssets_coal_min = EmissionsPerStrandedAssets; %min and max saved backwards
    ...
    hold off;
    ax = gca;
    exportgraphics(ax,'../Plots/scatter emissions per stranded assets coalmin_max.eps','ContentType','vector');
    ...
    hold off;
    ax = gca;
    exportgraphics(ax,'../Plots/scatter emissions per stranded assets oilmin_max.eps','ContentType','vector');
    ...
    EmissionsPerStrandedAssets_gas_min = EmissionsPerStrandedAssets; %min and max saved backwards
    ...
    hold off;
    ax = gca;
    exportgraphics(ax,'../Plots/scatter emissions per stranded assets gasmin_max.eps','ContentType','vector');
